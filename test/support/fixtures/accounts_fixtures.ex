defmodule PhoenixFromScratch.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `PhoenixFromScratch.Accounts` context.
  """
  ...
  def admin_fixture(attrs \\ %{}) do
    {:ok, admin} =
      ...
      |> PhoenixFromScratch.Accounts.register_admin()
  ...
  def user_fixture(attrs \\ %{}) do
    {:ok, user} =
      ...
      |> PhoenixFromScratch.Accounts.register_user()
